...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libcint_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("574b78ca-bebd-517c-801d-4735c93a9686"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libcint", artifacts_toml) for e in artifacts["libcint"]]
...
if best_platform === nothing
    @debug("Unable to load libcint; unsupported platform $(triplet(platform_key_abi()))")
else
